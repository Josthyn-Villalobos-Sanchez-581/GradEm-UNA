...
namespace App\Services\CertificadosServices;

use App\Repositories\CertificadosRepositories\CertificadoRepository;
...
class CertificadoService
{
    ...
    public function __construct(CertificadoRepository $repo)
    {
        $this->repo = $repo;
    }

...
export default function EditarOferta({
    ...
    const [form, setForm] = useState({
        ...
        id_area_laboral: String(oferta.id_area_laboral),
        id_modalidad: String(oferta.id_modalidad),
        descripcion: oferta.descripcion,
        horario: oferta.horario,
        id_carrera: String(oferta.id_carrera),
        fecha_limite: oferta.fecha_limite?.substring(0, 10),
        id_pais: String(oferta.id_pais),
        id_provincia: String(oferta.id_provincia),
        id_canton: String(oferta.id_canton),
        requisitos: (() => {
            try {

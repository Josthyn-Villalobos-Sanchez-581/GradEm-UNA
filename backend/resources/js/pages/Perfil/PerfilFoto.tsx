...
const handleUpload = async (e: React.FormEvent) => {
  ...
  try {
    ...
    modal.alerta({
      titulo: "Error",
      mensaje:
        "No se pudo subir la foto. Verifique el formato y el tamaño del archivo.",
    });
  }
};
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="rounded-lg border p-4 bg-gray-50">
            ...
            <ul className="list-disc list-inside text-sm space-y-1" style={{ color: COLORS.negro }}>
              ...
              <li>La imagen se ajustará automáticamente al perfil.</li>
              <li>Se recomienda una foto clara donde se vea el rostro.</li>
            </ul>
          </div>

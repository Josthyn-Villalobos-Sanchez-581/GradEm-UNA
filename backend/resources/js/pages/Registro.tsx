...
const Registro: React.FC = () => {
    ...
    const [identificacionRegistrada, setIdentificacionRegistrada] = useState(false);
    ...
    useEffect(() => {
        const timeout = setTimeout(async () => {
            ...
            // 🔹 Si está vacío, limpiamos el error
            if (!email) {
        ...
        }, 500); // ⏱️ espera 0.5 segundos antes de consultar
    ...
    function validarContrasena(valor: string): string | undefined {
        const v = (valor || '').trim();
        if (!v) return undefined; // ⚙️ solo mostrar si el usuario ha tocado el campo
    ...
    function validarConfirmacion(pass: string, confirm: string): string | undefined {
        if (!confirm) return undefined; // ⚙️ no mostrar al cargar
                        ...
                        <form className="mt-8 space-y-6" onSubmit={handleRegistro}>
                            ...
                            <div>
                                <label htmlFor="email" className="block text-sm font-bold text-black font-open-sans">
                                    {tipoCuenta === 'empresa' ? 'Correo electrónico (Correo de la empresa)' : 'Correo electrónico'}
                                </label>
                                <div className="mt-1 flex gap-2">
                                    <input
                                        ...
                                        className={`appearance-none rounded-md w-full px-3 py-2 border ${
                                            (errors as any).correo ? "border-red-500" : "border-una-gray"
                                        } text-gray-900 focus:ring-una-red focus:border-una-red sm:text-sm`}
                                ...
                                {(errors as any).correo && (
                                    <p id="correo-error" className="mt-1 text-sm text-red-600" role="alert" aria-live="assertive">
                                        {(errors as any).correo[0]}
                                    </p>
                                )}
                            </div>
                            ...
                            {codigoValidado && tipoCuenta !== "empresa" && (
                                <div className="rounded-md mt-6 space-y-6">
                                    {/* 🧩 Sección: Datos personales */}
                                    <div className="bg-gray-50 rounded-lg p-4 border shadow-sm">
                                        <h3 className="text-lg font-semibold text-gray-700 border-b pb-2 mb-4 text-center">
                                            Datos personales
                                        </h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className={`mt-1 appearance-none rounded-md relative block w-full px-3 py-2 border ${(errors as any).identificacion || identificacionRegistrada
                                                        ? "border-red-500"
                                                        : "border-una-gray"
                                                        } placeholder-una-gray text-gray-900 focus:outline-none focus:ring-una-red focus:border-una-red sm:text-sm`}
                                                    placeholder="Ej: 112345678 o AB123456"
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className={`mt-1 appearance-none rounded-md relative block w-full px-3 py-2 border ${(errors as any).nombre_completo ? 'border-red-500' : 'border-una-gray'
                                                        } placeholder-una-gray text-gray-900 focus:outline-none focus:ring-una-red focus:border-una-red sm:text-sm`}
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4 border shadow-sm mt-6">
                                        <h3 className="text-lg font-semibold text-gray-700 border-b pb-2 mb-4 text-center">
                                            Datos académicos
                                        </h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    className={`mt-1 block w-full px-3 py-2 border border-una-gray rounded-md shadow-sm text-una-dark-gray focus:outline-none focus:ring-una-red focus:border-una-red sm:text-sm ${tipoCuenta === "egresado" ? "bg-gray-100 cursor-not-allowed" : ""
                                                        }`}
                                                >
                                                ...
                                                <>
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className={`mt-1 appearance-none rounded-md relative block w-full px-3 py-2 border ${(errors as any).tiempo_conseguir_empleo ? "border-red-500" : "border-una-gray"
                                                                } placeholder-una-gray text-gray-900 focus:outline-none focus:ring-una-red focus:border-una-red sm:text-sm`}
                                                            placeholder="Ej: 6"
                                                    ...
                                                    <div>
                                                        ...
                                                        <select
                                                            ...
                                                            className={`mt-1 block w-full px-3 py-2 border ${(errors as any).area_laboral ? "border-red-500" : "border-una-gray"
                                                    ...
                                                    <div>
                                                        ...
                                                        <select
                                                            ...
                                                            className={`mt-1 block w-full px-3 py-2 border ${(errors as any).salario_promedio ? "border-red-500" : "border-una-gray"
                                                                } rounded-md shadow-sm text-una-dark-gray focus:outline-none focus:ring-una-red focus:border-una-red sm:text-sm`}
                                                    ...
                                                    <div>
                                                        ...
                                                        <select
                                                            ...
                                                            className={`mt-1 block w-full px-3 py-2 border ${(errors as any).tipo_empleo ? "border-red-500" : "border-una-gray"
                                                                } rounded-md shadow-sm text-una-dark-gray focus:outline-none focus:ring-una-red focus:border-una-red sm:text-sm`}

            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; padding:40px;">
                ...
                <tr>
                    <td style="padding-top:20px; font-size:15px; color:#555; text-align:center;">
                        Le informamos que el siguiente evento ha sido modificado:
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding-top:25px; font-size:14px; color:#555;">
                        <p style="font-weight:bold; margin-bottom:10px; color:#1a1a2e;">Cambios realizados:</p>
                        <ul style="padding-left:18px; line-height:1.6;">
                            @foreach($cambios as $campo => $valor)
                                @if($campo !== 'otras_observaciones') {{-- Evitamos duplicar si ya está en cambios --}}
